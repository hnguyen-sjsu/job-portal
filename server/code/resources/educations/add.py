...
class AddBatchEducations(Schema):
    educations = fields.List(fields.Nested(AddEducationSchema), required=True)
    ...
    def post(cls):
        ...
        try:
            for education in educations:
                ...
                education.end_date = convert_string_to_date(education.end_date)
                education.save_to_db()
        except SQLAlchemyError as e:
            abort(500, message='An error occurred while adding the job')
